...
class TestUSBSimulation:
    ...
    def test_read_frequency_simulation(self, protocol_file, manufacturer_file):
    ...
    def test_read_mode_simulation(self, protocol_file, manufacturer_file):
    ...
    def test_multiple_commands_in_sequence(self, protocol_file, manufacturer_file):
    ...
    def test_frequency_data_format(self, protocol_file, manufacturer_file):
