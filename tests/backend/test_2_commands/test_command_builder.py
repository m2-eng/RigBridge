...
class TestCommandBuilder:
    ...
    def test_executor_initialization(self, protocol_file, manufacturer_file):
    ...
    def test_build_read_frequency_frame(self, protocol_file, manufacturer_file):
    ...
    def test_invalid_command_name(self, protocol_file, manufacturer_file):
