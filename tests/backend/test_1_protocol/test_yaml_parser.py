...
class TestProtocolParser:
    ...
    def test_parser_initialization(self, protocol_file):
    ...
    def test_commands_loaded(self, protocol_file):
    ...
    def test_command_structure(self, protocol_file):
    ...
    def test_frame_config_loaded(self, protocol_file):
    ...
    def test_get_nonexistent_command(self, protocol_file):
    ...
    def test_response_decoder_exists(self, protocol_file):
